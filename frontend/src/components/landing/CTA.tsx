  ...
  return (
    <section className="px-4 py-20 sm:px-6 lg:px-8">
      <motion.div
        ...
        className="relative mx-auto max-w-5xl overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-teal-600 via-violet-600 to-violet-700 px-6 py-16 text-center shadow-2xl shadow-teal-600/30 sm:px-12 sm:py-20"
      >
        {/* decorative glow */}
        ...
        <div className="relative">
          <h2 className="font-display mx-auto max-w-2xl text-balance text-3xl font-extrabold tracking-tight text-white sm:text-5xl">
            Take control of your money today
          </h2>
          <p className="mx-auto mt-5 max-w-xl text-pretty text-base text-teal-100 sm:text-lg">
            Start budgeting smarter with BudgetIQ. Free to start — set up in minutes.
          </p>
